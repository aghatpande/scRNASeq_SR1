...
FeaturePlot(integrated_filtered_phased_noMito_seurat,
        ...
        label = TRUE)
```
We know 3 is affected by nUMI and nGene effects, clusters 4, 6 , 8, 9, perhaps 10 may be biologically different than B cells
...
## Differential analysis in B cells between conditions

### Subsetting out clusters 0,1,2
```{r}
# subsetting only CD19+ cells
BCells_CD19_seurat <- subset(integrated_ID_seurat,
                             idents = c("Bcell_CD19+_0", "Bcell_CD19+_1", "Bcell_CD19+_2"))

# revisualize 
DimPlot(BCells_CD19_seurat,
        reduction = "umap",
        label = TRUE,
        split.by = "sample")
...
## Alternate analysis keeping conditions separate after filtering
